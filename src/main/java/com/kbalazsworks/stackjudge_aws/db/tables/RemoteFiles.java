...
public class RemoteFiles extends TableImpl<RemoteFilesRecord> {
     ...
     */
    public final TableField<RemoteFilesRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("gen_random_uuid()", SQLDataType.UUID)), this, "");

    /**
     * The column <code>public.remote_files.path</code>.
     */
    public final TableField<RemoteFilesRecord, String> PATH = createField(DSL.name("path"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.remote_files.filename</code>.
     */
    public final TableField<RemoteFilesRecord, String> FILENAME = createField(DSL.name("filename"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.remote_files.s3_e_tag</code>.
     */
    public final TableField<RemoteFilesRecord, String> S3_E_TAG = createField(DSL.name("s3_e_tag"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.remote_files.s3_content_md5</code>.
     */
    public final TableField<RemoteFilesRecord, String> S3_CONTENT_MD5 = createField(DSL.name("s3_content_md5"), SQLDataType.VARCHAR(32).nullable(false), this, "");
    ...
    @Override
    public UniqueKey<RemoteFilesRecord> getPrimaryKey() {
        return Keys.REMOTE_FILES_PKEY;
    }
